...
Claude: `Skill(skill: "pipeline-handoff-doc", args: "role=<agent>, run-dir=<path>, next-focus=<text>")`

OC: `pipeline-handoff-doc` custom tool with `{role, run_dir, next_focus}` args.

Script: `python3 .claude/skills/pipeline-handoff-doc/handoff-doc.py --role <role> --run-dir <path> --next-focus <text>`
