...
```bash
python3 ~/.claude/skills/snyk/snyk.py projects --org org-1 --target-id target-1
# illustrative output:
...
```bash
python3 ~/.claude/skills/snyk/snyk.py targets --org org-1 --limit 5
# illustrative output:
...
```bash
python3 ~/.claude/skills/snyk/snyk.py issues --org org-1 --severity high
# illustrative output:
...
```bash
python3 ~/.claude/skills/snyk/snyk.py issue --org org-1 --id issue-1 --raw
# illustrative output:
{"jsonapi":{"version":"1.0"},"data":{"id":"issue-1"}}
```

```bash
python3 ~/.claude/skills/snyk/snyk.py findings --org org-1 --test test-1
# illustrative output:
...
```bash
python3 ~/.claude/skills/snyk/snyk.py issues --org org-1 --next '/orgs/org-1/issues?version=2026-03-25&starting_after=opaque&limit=20'
```
