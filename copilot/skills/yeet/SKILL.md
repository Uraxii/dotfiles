...
None. Do not stamp a model-identity trailer on commits; the model that ran
this skill did not necessarily write the code, and on a work machine that
false attribution lands in employer git history.
