...
Output: path to written handoff file.
"""
...
Resume in fresh session using task_id if supported, or re-read artifacts above.
"""


def main() -> int:
    parser = argparse.ArgumentParser(description="Write handoff document.")
